...
public class Assembler {
	...
	*/
    ...
    private void writeObjHeader() throws IOException { objW.write(String.format("H %-6s %-6d %-6d%n", baseName, programSize, programStack)); }
        ...
        if(v == null)
        {
	        ...
	        if (operatorPos > 0) {
	            ...
	            try {
	                ...
	                this.useTable.add(new useEntry(symbolName, this.lc +1, ModoRelocabilidade.ABSOLUTO, operator));
                ...
                this.useTable.add(new useEntry(sym, this.lc +1, ModoRelocabilidade.ABSOLUTO, Sinal.SOMA));
