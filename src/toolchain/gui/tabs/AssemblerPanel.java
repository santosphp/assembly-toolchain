...
public class AssemblerPanel extends JPanel implements VMListener {
    ...
    public AssemblerPanel(VirtualMachine vm) {
    ...
    private void setupLayout() {
	    ...
	    // Column 1: Editor ASM and Console (40% width) 
	    gbc.gridx = 0;
	    gbc.weightx = 0.2;
	    gbc.weighty = 1.0;
	    add(memoryPanel, gbc);

	    // Column 2: JTextArea OBJ and Console (30% width)
	    gbc.gridx = 1;
	    gbc.weightx = 0.4;
	    ...
	    // Column 3: JTextArea LST and Console  (30% width)
	    gbc.gridx = 2;
	    gbc.weightx = 0.3;
